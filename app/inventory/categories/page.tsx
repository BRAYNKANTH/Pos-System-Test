...
export default async function CategoriesPage() {
  ...
  // (see /api/inventory/categories) — the page was previously reachable
  // (and its rename/delete controls visible) to any logged-in user.
  ...
  if (!allowed) {
    return (
      <main className="mx-auto flex w-full max-w-lg flex-1 flex-col gap-2 px-6 py-16">
        ...
        <p className="text-sm text-zinc-500">You don&apos;t have permission to manage categories.</p>
      </main>
    );
  }
